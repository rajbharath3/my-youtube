    ...
    return (
        <div className='p-1 w-48 shadow-lg bg-white fixed l-0 overflow-y-scroll h-screen max-h-[85vh]'>
            ...
            <ul className='ml-5 p-3 font-semibold text-gray-700'>
                <Link to={"/results?search_query=Trending"}><li>Trending</li></Link>
                <Link to={"/results?search_query=Shopping"}><li>Shopping</li></Link>
                <Link to={"/results?search_query=music"}><li>Music</li></Link>
                <Link to={"/results?search_query=movies"}><li>Movies</li></Link>
                <Link to={"/results?search_query=live"}><li>Live</li></Link>
                <Link to={"/results?search_query=gaming"}><li>Gaming</li></Link>
